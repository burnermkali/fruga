(function($) {
  ...
  $(function() {
    if ($("#order-chart").length) {
      var areaData = {
        labels: ["league 1","league 2","league 3","league 4","league 5"],
        datasets: [
          {
            data: [5, 6, 9, 3, 7],
            borderColor: [
    ...
    //Kobe Bryant Player stats


    if ($("#kobe").length) {
      var areaData = {
        labels: ["2PT", "3PT", "Paint"],
        datasets: [{
            data: [45, 35, 20],
            backgroundColor: [
               "#4B49AC","#FFC100", "#adff2f"
            ],
      ...
      var areaOptions = {
        ...
        legendCallback: function(chart) { 
          ...
          text.push('<div class="report-chart">');
            text.push('<div class="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div class="d-flex align-items-center"><div class="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[0] + '"></div><p class="mb-0">2PT</p></div>');
            text.push('<p class="mb-0">45</p>');
            text.push('</div>');
            text.push('<div class="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div class="d-flex align-items-center"><div class="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[1] + '"></div><p class="mb-0">3PT</p></div>');
            text.push('<p class="mb-0">35</p>');
            text.push('</div>');
            text.push('<div class="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div class="d-flex align-items-center"><div class="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[2] + '"></div><p class="mb-0">Paint</p></div>');
      ...
      var northAmericaChartCanvas = $("#kobe").get(0).getContext("2d");
      ...
      document.getElementById('kobe-legend').innerHTML = northAmericaChart.generateLegend();
    }

    //End of Kobe Player Stats

    //Kareem Abdul Player Stats
    ...
    if ($("#kareem").length) {
      ...
      var northAmericaChartCanvas = $("#kareem").get(0).getContext("2d");
      var northAmericaChart = new Chart(northAmericaChartCanvas, {
        type: 'doughnut',
        data: areaData,
        options: areaOptions,
      ...
      document.getElementById('kareem-legend').innerHTML = northAmericaChart.generateLegend();
    }


   

    //End of Kareem Player Stats
    ...
    if ($("#steph").length) {
      ...
      var northAmericaChartCanvas = $("#steph").get(0).getContext("2d");
      var northAmericaChart = new Chart(northAmericaChartCanvas, {
        type: 'doughnut',
        data: areaData,
        options: areaOptions,
      ...
      document.getElementById('steph-legend').innerHTML = northAmericaChart.generateLegend();
    }
    ...
    if ($("#shaq").length) {
      ...
      var northAmericaChartCanvas = $("#shaq").get(0).getContext("2d");
      var northAmericaChart = new Chart(northAmericaChartCanvas, {
        type: 'doughnut',
        data: areaData,
        options: areaOptions,
      ...
      document.getElementById('shaq-legend').innerHTML = northAmericaChart.generateLegend();
    }

    //end of shaq player stats
    ...
    if ($("#lebron").length) {
      ...
      var northAmericaChartCanvas = $("#lebron").get(0).getContext("2d");
      var northAmericaChart = new Chart(northAmericaChartCanvas, {
        type: 'doughnut',
        data: areaData,
        options: areaOptions,
      ...
      document.getElementById('lebron-legend').innerHTML = northAmericaChart.generateLegend();
    }


    //end of lebron player stats
